describe('Test the mostProfitableDepartment function' , function(){
    it("It should return 'outdoor' as the most profitable department for the dataset 1", function(){
        var salesData = [
    ...
    it("It should return 'electronics' as the most profitable department for the dataset 2 ", function(){
        var salesData2 = [
